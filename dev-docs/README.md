# CONS Job - Developer Documentation

> [!IMPORTANT]
> **About This Documentation:** CONS Job is an adaptation of the original **LITHP** project (a Common Lisp IDE). The documentation in this folder was created during the development of LITHP and has been preserved for historical reference. All references to "LITHP", "Lisp", "CLISP", and "SBCL" in these documents should be understood in the context of the original project. 
>
> CONS Job has been adapted to support **Scheme** instead of Common Lisp, with support for interpreters like MIT Scheme, Guile, Chez Scheme, and others. The core architecture and design patterns remain the same.

---

A comprehensive documentation set originally created for building the LITHP educational Common Lisp IDE, now serving as the foundation for CONS Job (Scheme Development Environment).
