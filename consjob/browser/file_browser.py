...
class SchemeFileFilterProxy(QSortFilterProxyModel):
    ...
    def filterAcceptsRow(self, source_row, source_parent):
        ...
        return name.endswith('.scm') or name.endswith('.ss') or name.endswith('.sld') or name.endswith('.sls')
...
class FileBrowser(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.proxy_model = SchemeFileFilterProxy(self)
