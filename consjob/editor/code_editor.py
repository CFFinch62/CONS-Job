...
from consjob.editor.highlighter import SchemeHighlighter
from consjob.editor.paren_matcher import ParenMatcher
...
class CodeEditor(QPlainTextEdit):
    def __init__(self, parent=None):
        ...
        self.highlighter = SchemeHighlighter(self.document())
