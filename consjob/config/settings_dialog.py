...
from consjob.config.scheme_detector import detect_scheme_interpreters, is_valid_interpreter
...
class SettingsDialog(QDialog):
    ...
    def create_terminal_tab(self):
        ...
        # Scheme Interpreter Selection Group
        interpreter_group = QGroupBox("Scheme Interpreter")
        ...
        refresh_btn.setToolTip("Re-scan for installed Scheme interpreters")
        ...
        self.lisp_path_edit.setPlaceholderText("Path to Scheme interpreter executable")
    ...
    def refresh_interpreters(self):
        ...
        self.detected_interpreters = detect_scheme_interpreters()
    ...
    def browse_lisp(self):
        """Browse for a Scheme interpreter executable."""
        path, _ = QFileDialog.getOpenFileName(self, "Select Scheme Interpreter Executable")
        if path:
            self.lisp_path_edit.setText(path)
            self.custom_path_check.setChecked(True)
